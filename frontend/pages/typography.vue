<template>
  <div
    class="relative flex flex-col justify-center min-h-screen py-8 overflow-hidden bg-gray-50 lg:py-12"
  >
    <img
      src="https://play.tailwindcss.com/img/beams.jpg"
      alt=""
      class="fixed -translate-y-1/2 top-48 left-1/2 -translate-x-2/3 max-w-none"
      width="1308"
    >
    <div
      class="
...
&lt;/article&gt;
  ...
  plugins: [],
        ...
        <p>
          ...
          the list item. That means I have to worry about styling that annoying
          situation too.
        </p>
        <ul>
          <li>
